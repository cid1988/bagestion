...
},
{
    ...
    actions: {
        ...
        save: {
            urls: ['/orm.soporte','/orm.soporte/:_id'],
            kind: 'findAndModify'
        },
        delete: {
            kind: 'remove'
...
},
{
    ...
    name: 'ORMPrioridades',
    collectionName: 'orm.prioridades',
    url: '/orm.prioridades/:_id',
    params: {
        _id: '@_id'
    },
    actions: {
        list: {
            urls: ['/orm.prioridades'],
            kind: 'find'
        },
        findByInstancia: {
            kind: 'findOne'
        ...
        save: {
            urls: ['/orm.prioridades','/orm.prioridades/:_id'],
            kind: 'findAndModify'
        },
        delete: {
            kind: 'remove'
