angular.module('bag2.app', ["angulartics.bag2", "ui.state", "ngRoute", "compile"]).config(function($provide, $routeProvider, $locationProvider, $stateProvider) {
...
}).run(function(auth, $urlRouter, $stateProvider, $routeProvider, $http, $route, $rootScope, $location, $timeout, $state, $stateParams, checkUrl, concatAndResolveUrl, $q, getUiStates, updateRoutes, Contactos, ORMOrganigrama, Comuna) {
    ...
    $rootScope.comunaPorId = function(id) {
...
.run(function ($interval, $http) {
    $interval(function () {
      $http.post('/angulartics-usertick', {});
    }, 60000);
    $http.post('/angulartics-usertick', {});
})
